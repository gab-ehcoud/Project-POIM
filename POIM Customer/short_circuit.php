...
<body>
    <div class="contact-clean">
        <form method="post">
            <h3 class="text-center" style="margin: 0px 0px 20px 0px;">Short Circuit&nbsp;</h3>
            <div class="form-group"><input class="form-control" type="text" name="meter_no" placeholder="meter_no"></div>
